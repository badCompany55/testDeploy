...
var _loginForm = require("./src/loginForm.js");
...
var router = new _sparouter["default"](options); // render function to allow for state in the app without react
...
var render = function render(component) {
  ...
  /* , options = {} */
    ...
    var start = options.focus ? document.getElementById(options.focus).selectionStart : 0;
    (document.getElementById(mountNode) || {}).innerHTML = stateRepresentation;

    if (options.focus) {
      var f = document.getElementById(options.focus);
...
router.get('/', function (req, router) {
  render(_homePage.HomePage, {}, "app");
}).setName("home");
router.get('/login', function (req, router) {
  render(_loginForm.RegistrationForm);
});
router.init();

},{"./src/homePage.js":2,"./src/loginForm.js":3,"@kodnificent/sparouter":4}],2:[function(require,module,exports){
"use strict";
...
var HomePage = function HomePage(_ref) {
  ...
  (0, _main.intent)("onNavigate", function (e) {
...
},{"../main.js":1}],4:[function(require,module,exports){
